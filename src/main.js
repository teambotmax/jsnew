...
\n\n# http://line.me/ti/p/~gerhanaselatan";
    ...
    poll(operation) {
		...
		if(operation.type == 15 && isAdminOrBot(operation.param2)) {//ada yang leave
			...
			babay.toType = 2;
			babay.text = "Idich Baru gitu dah baper hhhhj?";
...
\n";
        ...
        }else if(txt === 'sepi' && !isAdminOrBot(seq.from_) && seq.toType == 2){this._sendMessage(seq,"Not permitted !");}
